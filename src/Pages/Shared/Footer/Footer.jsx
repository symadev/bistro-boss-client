const Footer = () => {
  return (
    <>
      ...
      <footer className="bg-neutral text-neutral-content p-10">
        <div className="container mx-auto flex flex-col md:flex-row justify-between items-center gap-10">
          <div className="flex items-center gap-4">
            ...
            <p>
              <strong>Bistro Boss</strong>
              <br />
              Serving delicious moments since 1992
            </p>
          </div>
      ...
      {/* Bottom Section */}
      <footer className="footer footer-center text-white bg-black border border-white text-base-content p-4 mb-4">
        <aside>
          <p>
